...
const Home = () => {
  ...
  return (
    <section
      ...
      bg-gradient-to-br from-saffron-50 via-white to-green-50
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 animate-slide-up">
            <div>
              ...
              <div className="h-12 mt-2 flex items-center justify-center lg:justify-start">
                <p className="text-2xl sm:text-3xl lg:text-4xl font-semibold bg-gradient-to-r from-saffron-500 via-green-500 to-saffron-600 bg-clip-text text-transparent">
                  {roles[currentRole]}
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6 justify-center lg:justify-start pt-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group p-4 bg-white dark:bg-gray-800 rounded-full shadow-lg hover:scale-110"
              >
                <Linkedin
                  size={24}
                  className="text-saffron-600 group-hover:text-blue-600"
                />
              </a>
              ...
              >
                <Code2
                  size={24}
                  className="text-saffron-600 group-hover:text-orange-600"
                />
              </a>
              ...
              >
                <Github
                  size={24}
                  className="text-saffron-600 group-hover:text-gray-900 dark:group-hover:text-white"
                />
              </a>
            </div>
          </div>
